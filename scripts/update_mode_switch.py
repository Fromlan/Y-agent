#!/usr/bin/env python3
"""Update ModeSwitch.tsx to add the "video" (生视频) option.
"""
from pathlib import Path

MODE_SWITCH = Path("E:/Pi/Y-agent/src/components/workspace/ModeSwitch.tsx")

NEW_CONTENT = '''import { Image as ImageIcon, MessageSquare, Video, Wrench } from "lucide-react";
...
def main() -> int:
    MODE_SWITCH.write_text(NEW_CONTENT, encoding="utf-8")
    print(f"wrote {MODE_SWITCH}")
    return 0
