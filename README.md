...
15 个预置 Skill（角色三视图 / 表情包 / KV 海报 / UI 图标等），输入 `/` 即选；想自由发挥就让 LLM 陪你磨 prompt 和画风。
...
| | |
|---|---|
| 🧩 **15 预置 Skill** | 角色三视图 / 转面 / 表情包 / KV 海报 / 场景氛围 / UI 图标 / 图层拆分 / 局部编辑 / 透明图标包 / 角色一致性 / 光影变体 / 商品套图 / 信息图海报 / UI 单页 / 组件拆解 |
